...
<script type="text/javascript"
	src="js/pages/back/admin/storageaudit/storageaudit_edit.js"></script>
...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper text-left">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<div>
						<form class="form-horizontal" action="<%=STORAGEAUDIT_EDIT_URL%>"
	...
	<jsp:include
		page="/WEB-INF/pages/plugins/back/info/member_info_modal.jsp" />
	<jsp:include
		page="/WEB-INF/pages/plugins/back/info/warehouse_info_modal.jsp" />
	<jsp:include
